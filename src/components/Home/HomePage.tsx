        ...
        <Container maxW='container.xl'>
          ...
          >
            <Stack spacing={6} maxW='lg'>
              <Heading as='h1' size='2xl' fontWeight='bold' lineHeight='shorter' color='primary.700'>
                {t('home.title')}
              </Heading>
              ...
              <Stack direction={{ base: 'column', sm: 'row' }} spacing={4}>
                <Button size='lg' colorScheme='primary' onClick={() => navigate(ROUTES.SEARCH)}>
                  {t('home.findTools')}
                </Button>
                <Button size='lg' variant='outline' colorScheme='primary' onClick={() => navigate(ROUTES.TOOLS.NEW)}>
                  {t('tools.addTool')}
                </Button>
              </Stack>
            </Stack>
            <Box maxW={{ base: '300px', lg: '400px' }} w='full' h='auto' position='relative'>
              <Box
                as='img'
      ...
      <Box py={{ base: 20, md: 28 }} bg={bgColor}>
        <Container maxW='container.xl'>
          <Stack spacing={12}>
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 12, md: 10 }}>
